...
export default function CreateProject() {
    const { title, description, category, status, handleChange, handleSubmit, handlePublic, handleTags, handleCategory, handleStatus, isPublicProject, tags} = UseForm();
    ...
    return(
        <form onSubmit={handleSubmit} id="create-project">
            ...
            <input name="category" id="category" value={category} onChange={handleCategory}></input>
            <label htmlFor="">Status</label>
            <input name="status" id="status" value={status} onChange={handleStatus}></input>
